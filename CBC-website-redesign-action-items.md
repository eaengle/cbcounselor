...
- [x] Use verified versions of these proof points:
  ...
  - ~~Two ITC Section 337 investigations as lead counsel.~~ ✅ **Revised 2026-07-13 — count removed.** The firm could not substantiate the number "two" (a further ITC matter recently resolved, and Gong Chen's bio describes a third Section 337 action). The tile now reads **"Lead counsel in ITC Section 337 investigations"** with no figure — true regardless of the final count. No longer gated. See report B1/D3.
...
- [x] Do not use the $66 million trade-secret verdict as a firm-wide homepage credential; confine it to Ben Stolter’s bio. ⚠ **Corrected 2026-07-13:** Alan confirmed the verdict is **Edwin Wheeler’s**, not Ben Solter’s — the redline misattributed it. The “not a firm-wide credential” instruction stands and is implemented; the verdict correctly remains in Wheeler’s bio (`attorneys.ts:171`). See report D1.
